...
implements Serializable {
    ...
    public final MatchResult matchAt(@NotNull CharSequence charSequence, int n) {
        ...
        Matcher matcher;
        Intrinsics.checkNotNullParameter(charSequence, "input");
        Matcher matcher2 = matcher = this.nativePattern.matcher(charSequence).useAnchoringBounds(false).useTransparentBounds(true).region(n, charSequence.length());
        boolean bl = false;
...
lbl46:
    ...
    public static final class Companion {
        ...
        public final String escape(@NotNull String string) {
            ...
            Intrinsics.checkNotNullExpressionValue(string2, "quote(...)");
            return string2;
        }
        ...
        public final String escapeReplacement(@NotNull String string) {
            ...
            Intrinsics.checkNotNullExpressionValue(string2, "quoteReplacement(...)");
            return string2;
        }

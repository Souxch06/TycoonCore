                ...
                if (!iterator2.hasNext()) {
                    ...
                    while (true) {
                        ...
                        if (n3 >= objectArray2.length) {
                            ...
                            Intrinsics.checkNotNullExpressionValue(Arrays.copyOf(objectArray2, n4), "copyOf(...)");
                            continue;
                        }
                ...
                if (!iterator2.hasNext()) {
                    ...
                    while (true) {
                        ...
                        if (n2 >= objectArray4.length) {
                            ...
                            Intrinsics.checkNotNullExpressionValue(Arrays.copyOf(objectArray4, n3), "copyOf(...)");
                            continue;
                        }
                        if (!iterator2.hasNext()) break;
                    }
                    ...
                    if (objectArray5 == objectArray) {
                        ...
                        Intrinsics.checkNotNullExpressionValue(objectArray6, "copyOf(...)");
                    }
                }
            }
        }
    ...
    private static final Object[] toArrayImpl(Collection<?> collection, Function0<Object[]> function0, Function1<? super Integer, Object[]> function1, Function2<? super Object[], ? super Integer, Object[]> function2) {
        ...
        while (true) {
            ...
            if (n2 >= objectArray.length) {
                ...
                Intrinsics.checkNotNullExpressionValue(Arrays.copyOf(objectArray, n3), "copyOf(...)");
                continue;
            }
            if (!iterator2.hasNext()) break;
        }

...
@Metadata(mv={1, 9, 0}, k=1, xi=48, d1={"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0006\n\u0000\b\u00c6\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002J\u0018\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eH\u0016R\"\u0010\u0003\u001a\u0010\u0012\f\b\u0001\u0012\b\u0012\u0004\u0012\u00020\u00060\u00050\u00048VX\u0096\u0004\u00a2\u0006\u0006\u001a\u0004\b\u0007\u0010\b\u00a8\u0006\u000f"}, d2={"Lorg/holoeasy/packet/rotate/RotatePacketA;", "Lorg/holoeasy/packet/rotate/IRotatePacket;", "()V", "versionSupport", "", "Lkotlin/ranges/ClosedRange;", "Lorg/holoeasy/util/VersionEnum;", "getVersionSupport", "()[Lkotlin/ranges/ClosedRange;", "rotate", "Lcom/comphenix/protocol/events/PacketContainer;", "entityId", "", "yaw", "", "holoeasy-core"})
public final class RotatePacketA
implements IRotatePacket {
    @NotNull
    public static final RotatePacketA INSTANCE = new RotatePacketA();

    private RotatePacketA() {
    }
    ...
    @Override
    @NotNull
    public PacketContainer rotate(int n, double d) {
        PacketType packetType = PacketType.Play.Server.ENTITY_LOOK;
        Intrinsics.checkNotNullExpressionValue(packetType, "ENTITY_LOOK");
        return PacketBuilderKt.packet(packetType, (Function1<? super PacketContainer, Unit>)new Function1<PacketContainer, Unit>(n, d){
            ...
            public final void invoke(@NotNull PacketContainer packetContainer) {
                ...
                StructureModifier structureModifier2 = packetContainer.getBytes();
                Intrinsics.checkNotNullExpressionValue(structureModifier2, "getBytes(...)");
                StructureModifierExtKt.set(structureModifier2, 0, DoubleExtKt.getCompressAngle(this.$yaw));
            }
        });
    }
    ...
    public boolean isCurrentVersion() {
        return IRotatePacket.DefaultImpls.isCurrentVersion(this);
    }
}

...
implements IMetadataTextPacket {
    ...
    public PacketContainer metadata(int n, @Nullable String string, boolean bl) {
        ...
        if (string != null) {
            WrappedDataWatcherExtKt.setString(wrappedDataWatcher, 2, string);

...
public class XML {
    ...
    private static boolean parse(XMLTokener xMLTokener, JSONObject jSONObject, String string, XMLParserConfiguration xMLParserConfiguration, int n) {
        String string2;
    ...
    public static JSONObject toJSONObject(Reader reader, boolean bl) {
        if (bl) {
    ...
    public static JSONObject toJSONObject(String string, XMLParserConfiguration xMLParserConfiguration) {
    ...
    public static String toString(Object object, String string, XMLParserConfiguration xMLParserConfiguration) {
        return XML.toString(object, string, xMLParserConfiguration, 0, 0);
    }

    private static String toString(Object object, String string, XMLParserConfiguration xMLParserConfiguration, int n, int n2) {
        String string2;
    ...
    public static String toString(Object object, String string, XMLParserConfiguration xMLParserConfiguration, int n) {

...
import xyz.arcadiadevs.valoriatycoon.utils.config.message.PlayerMessage;

public enum Messages {
    NO_PERMISSION("no-permission", "&cErreur> &7Vous n'avez pas la permission de faire cela !"),
    PLUGIN_RELOADED("plugin-reloaded", "&9ValoriaTycoon> &7Plugin rechargé !"),
    ...
    GENERATOR_GIVEN("generator-given", "&9ValoriaTycoon> &7Vous avez donné &a%amount% &7générateur(s) de palier &a%tier% &7à &a%targetPlayer%"),
    GENERATOR_RECEIVED("generator-received", "&9ValoriaTycoon> &7Vous avez reçu &a%amount% &7générateur(s) de palier &a%tier%"),
    LIMIT_REACHED("limit-reached", "&cErreur> &7Vous avez atteint la limite de &c%limit% &7générateurs !"),
    EVENT_STARTED("event-started", "&9ValoriaTycoon> &7%event% a commencé et se terminera dans &e&n%time%&7 !"),
    EVENT_ENDED("event-ended", "&9ValoriaTycoon> &7%event% est terminé. Un nouvel événement commencera dans &e&n%time%&7 !"),
    EVENT_FORCE_ENDED("event-force-ended", "&9ValoriaTycoon> &7L'événement a été arrêté de force ! Un nouvel événement commencera dans &e&n%time%&7 !"),
    ...
    SUCCESSFULLY_UPGRADED("successfully-upgraded", "&9ValoriaTycoon> &7Votre générateur a été amélioré au palier &a%tier% &7avec succès !"),
    SUCCESSFULLY_SOLD("successfully-sold", "&9ValoriaTycoon> &7Drops vendus avec succès pour &a%price%"),
    ...
    SUCCESSFULLY_DESTROYED("successfully-destroyed", "&9ValoriaTycoon> &7Générateur détruit avec succès !"),
    SUCCESSFULLY_PLACED("successfully-placed", "&9ValoriaTycoon> &7Générateur de palier %tier% placé avec succès !"),
    SUCCESSFULLY_BOUGHT("successfully-bought", "&9ValoriaTycoon> &7Générateur de palier %tier% acheté avec succès pour %price% !"),
    ...
    GENERATOR_GIVEN_ALL("generator-given-all", "&9ValoriaTycoon> &7Vous avez donné &a%amount% &7générateur(s) de palier &a%tier% &7à tous les joueurs ! (&a%count%&7)"),
    DEFAULT_MESSAGE("default-message", "&9ValoriaTycoon> &7Ce serveur utilise ValoriaTycoon &av%version%"),
    ...
    SELL_WAND_GIVEN("sell-wand-given", "&9ValoriaTycoon> &7Vous avez donné une baguette de vente !"),
    SELL_WAND_RECEIVED("sell-wand-received", "&9ValoriaTycoon> &7Vous avez reçu une baguette de vente !"),
    UPGRADE_WAND_GIVEN("upgrade-wand-given", "&9ValoriaTycoon> &7Vous avez donné une baguette d'amélioration !"),
    UPGRADE_WAND_RECEIVED("upgrade-wand-received", "&9ValoriaTycoon> &7Vous avez reçu une baguette d'amélioration !"),
    WAND_BROKE("wand-broke", "&cErreur> &7Votre baguette s'est cassée !"),
    LIMIT_UPDATED("limit-updated", "&9ValoriaTycoon> &7Vous avez défini la limite de générateurs de %player% à &a%limit%&7 !");
    ...
    public static void init() {
        File file = new File(ValoriaTycoon.getInstance().getDataFolder(), "messages.yml");

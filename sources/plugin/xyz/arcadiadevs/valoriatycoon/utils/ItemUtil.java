...
public class ItemUtil {
        ...
        while (n < inventory.getSize()) {
            ...
            if (itemStack != null && (itemMeta = itemStack.getItemMeta()) != null && itemMeta.hasLore() && (list = itemMeta.getLore()) != null) {
                ...
                if (string.contains("Palier du drop de générateur")) {
                    ...
                    itemStack.setItemMeta(itemMeta);
                    itemStack = NBTEditor.set(itemStack, var6_6, "valoriatycoon", "spawnitem", "tier");
                    ...
                    itemMeta.setLore(list);
                    itemStack.setItemMeta(itemMeta);
                    itemStack = NBTEditor.set(itemStack, var6_6, "valoriatycoon", "blocktype", "tier");
                    inventory.setItem(n, itemStack);
                }
            }
            ++n;
    ...
    public static ItemStack getWand(WandData.Wand.WandType wandType, int n, double d) {
        WandData wandData = ValoriaTycoon.getInstance().getWandData();

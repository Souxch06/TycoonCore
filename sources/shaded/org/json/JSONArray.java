...
implements Iterable<Object> {
    ...
    public Boolean optBooleanObject(int n) {
        return this.optBooleanObject(n, false);
    }

    public Boolean optBooleanObject(int n, Boolean bl) {
        try {
            return this.getBoolean(n);
        }
        catch (Exception exception) {
    ...
    public Double optDoubleObject(int n) {
        return this.optDoubleObject(n, Double.NaN);
    }

    public Double optDoubleObject(int n, Double d) {
        Number number = this.optNumber(n, null);
        if (number == null) {
            return d;
        }
    ...
    public Float optFloatObject(int n) {
        return this.optFloatObject(n, Float.valueOf(Float.NaN));
    }

    public Float optFloatObject(int n, Float f) {
        Number number = this.optNumber(n, null);
        if (number == null) {
            return f;
        }
        Float f2 = Float.valueOf(number.floatValue());
        return f2;
    }
    ...
    public Integer optIntegerObject(int n) {
        return this.optIntegerObject(n, 0);
    }

    public Integer optIntegerObject(int n, Integer n2) {
        Number number = this.optNumber(n, null);
        if (number == null) {
            return n2;
        }
    ...
    public JSONArray optJSONArray(int n) {
        return this.optJSONArray(n, null);
    }

    public JSONArray optJSONArray(int n, JSONArray jSONArray) {
        Object object = this.opt(n);
        return object instanceof JSONArray ? (JSONArray)object : jSONArray;
    }

    public JSONObject optJSONObject(int n) {
        return this.optJSONObject(n, null);
    }

    public JSONObject optJSONObject(int n, JSONObject jSONObject) {
        Object object = this.opt(n);
    ...
    public Long optLongObject(int n) {
        return this.optLongObject(n, 0L);
    }

    public Long optLongObject(int n, Long l) {
        Number number = this.optNumber(n, null);
        if (number == null) {
            return l;
        }
    ...
    public JSONArray put(int n, float f) {
    ...
    public JSONArray putAll(Object object) {
    ...
    private void addAll(Object object, boolean bl) {
        if (object.getClass().isArray()) {

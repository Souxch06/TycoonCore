...
public class JSONML {
    private static Object parse(XMLTokener xMLTokener, boolean bl, JSONArray jSONArray, boolean bl2, int n) {
    ...
    private static Object parse(XMLTokener xMLTokener, boolean bl, JSONArray jSONArray, JSONMLParserConfiguration jSONMLParserConfiguration, int n) {
        String string = null;
    ...
    public static JSONArray toJSONArray(String string, boolean bl) {
        return (JSONArray)JSONML.parse(new XMLTokener(string), true, null, bl, 0);
    }

    public static JSONArray toJSONArray(String string, JSONMLParserConfiguration jSONMLParserConfiguration) {
    ...
    public static JSONArray toJSONArray(XMLTokener xMLTokener, boolean bl) {
    ...
    public static JSONObject toJSONObject(String string, boolean bl) {
        return (JSONObject)JSONML.parse(new XMLTokener(string), false, null, bl, 0);
    }

    public static JSONObject toJSONObject(String string, JSONMLParserConfiguration jSONMLParserConfiguration) {
    ...
    public static JSONObject toJSONObject(XMLTokener xMLTokener, boolean bl) {

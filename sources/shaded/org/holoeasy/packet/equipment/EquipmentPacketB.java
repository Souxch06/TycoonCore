...
@Metadata(mv={1, 9, 0}, k=1, xi=48, d1={"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u00c6\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002J\u0018\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eH\u0016R\"\u0010\u0003\u001a\u0010\u0012\f\b\u0001\u0012\b\u0012\u0004\u0012\u00020\u00060\u00050\u00048VX\u0096\u0004\u00a2\u0006\u0006\u001a\u0004\b\u0007\u0010\b\u00a8\u0006\u000f"}, d2={"Lorg/holoeasy/packet/equipment/EquipmentPacketB;", "Lorg/holoeasy/packet/equipment/IEquipmentPacket;", "()V", "versionSupport", "", "Lkotlin/ranges/ClosedRange;", "Lorg/holoeasy/util/VersionEnum;", "getVersionSupport", "()[Lkotlin/ranges/ClosedRange;", "equip", "Lcom/comphenix/protocol/events/PacketContainer;", "entityId", "", "helmet", "Lorg/bukkit/inventory/ItemStack;", "holoeasy-core"})
public final class EquipmentPacketB
implements IEquipmentPacket {
    @NotNull
    public static final EquipmentPacketB INSTANCE = new EquipmentPacketB();

    private EquipmentPacketB() {
    }

    @Override
    @NotNull
    public ClosedRange<VersionEnum>[] getVersionSupport() {
        ClosedRange[] closedRangeArray = new ClosedRange[]{RangesKt.rangeTo((Comparable)VersionEnum.V1_9, (Comparable)VersionEnum.V1_12)};
    ...
    public PacketContainer equip(int n, @NotNull ItemStack itemStack) {
        ...
        return PacketBuilderKt.packet(packetType, (Function1<? super PacketContainer, Unit>)new Function1<PacketContainer, Unit>(n, itemStack){
            ...
            public final void invoke(@NotNull PacketContainer packetContainer) {
                ...
                StructureModifier structureModifier2 = packetContainer.getItemSlots();
                Intrinsics.checkNotNullExpressionValue(structureModifier2, "getItemSlots(...)");
                StructureModifierExtKt.set(structureModifier2, 0, EnumWrappers.ItemSlot.HEAD);
                StructureModifier structureModifier3 = packetContainer.getItemModifier();
                Intrinsics.checkNotNullExpressionValue(structureModifier3, "getItemModifier(...)");
                StructureModifierExtKt.set(structureModifier3, 0, this.$helmet);
            }
        });
    }

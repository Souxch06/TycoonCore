...
implements ISpawnPacket {
    ...
    public ClosedRange<VersionEnum>[] getVersionSupport() {
        ClosedRange[] closedRangeArray = new ClosedRange[]{RangesKt.rangeTo((Comparable)VersionEnum.V1_16, (Comparable)VersionEnum.V1_18)};
    ...
    public PacketContainer spawn(int n, @NotNull EntityType entityType, @NotNull Location location, @Nullable Plugin plugin) {
        ...
        if (entityType == EntityType.ARMOR_STAND) {
            ...
            return PacketBuilderKt.packet(packetType, (Function1<? super PacketContainer, Unit>)new Function1<PacketContainer, Unit>(n, n2, location){
        ...
        Intrinsics.checkNotNullExpressionValue(packetType, "SPAWN_ENTITY");
        return PacketBuilderKt.packet(packetType, (Function1<? super PacketContainer, Unit>)new Function1<PacketContainer, Unit>(n, location){
            ...
            public final void invoke(@NotNull PacketContainer packetContainer) {
                ...
                Intrinsics.checkNotNullExpressionValue(structureModifier, "getIntegers(...)");
                StructureModifierExtKt.set(structureModifier, 0, this.$entityId);
                StructureModifier structureModifier2 = packetContainer.getEntityTypeModifier();
                Intrinsics.checkNotNullExpressionValue(structureModifier2, "getEntityTypeModifier(...)");
                StructureModifierExtKt.set(structureModifier2, 0, EntityType.DROPPED_ITEM);
                StructureModifier structureModifier3 = packetContainer.getUUIDs();
                Intrinsics.checkNotNullExpressionValue(structureModifier3, "getUUIDs(...)");
                StructureModifierExtKt.set(structureModifier3, 0, UUID.randomUUID());
                StructureModifier structureModifier4 = packetContainer.getDoubles();
                Intrinsics.checkNotNullExpressionValue(structureModifier4, "getDoubles(...)");
                StructureModifierExtKt.set(structureModifier4, 0, this.$location.getX());
                StructureModifier structureModifier5 = packetContainer.getDoubles();
                Intrinsics.checkNotNullExpressionValue(structureModifier5, "getDoubles(...)");
                StructureModifierExtKt.set(structureModifier5, 1, this.$location.getY());
                StructureModifier structureModifier6 = packetContainer.getDoubles();
                Intrinsics.checkNotNullExpressionValue(structureModifier6, "getDoubles(...)");
                StructureModifierExtKt.set(structureModifier6, 2, this.$location.getZ());
                StructureModifier structureModifier7 = packetContainer.getIntegers();
                Intrinsics.checkNotNullExpressionValue(structureModifier7, "getIntegers(...)");
                StructureModifierExtKt.set(structureModifier7, 2, SpawnPacketC.access$convertVelocity(SpawnPacketC.INSTANCE, 0.0));
                StructureModifier structureModifier8 = packetContainer.getIntegers();
                Intrinsics.checkNotNullExpressionValue(structureModifier8, "getIntegers(...)");
                StructureModifierExtKt.set(structureModifier8, 3, SpawnPacketC.access$convertVelocity(SpawnPacketC.INSTANCE, 0.0));
                StructureModifier structureModifier9 = packetContainer.getIntegers();
                Intrinsics.checkNotNullExpressionValue(structureModifier9, "getIntegers(...)");
                StructureModifierExtKt.set(structureModifier9, 4, SpawnPacketC.access$convertVelocity(SpawnPacketC.INSTANCE, 0.0));
            }
        });
    }

    private final int convertVelocity(double d) {
        return (int)(this.clamp(d, -3.9, 3.9) * (double)8000);
    }
    ...
    public static final /* synthetic */ int access$convertVelocity(SpawnPacketC spawnPacketC, double d) {
        return spawnPacketC.convertVelocity(d);
    }
}

...
implements IMetadataItemPacket {
    ...
    public PacketContainer metadata(int n, @NotNull ItemStack itemStack) {
        ...
        WrappedDataValue[] wrappedDataValueArray = new WrappedDataValue[]{new WrappedDataValue(5, SerializersKt.getBOOL_SERIALIZER(), (Object)true), new WrappedDataValue(8, SerializersKt.getITEM_SERIALIZER(), ItemStackExtKt.bukkitGeneric(itemStack))};
        packetContainer.getDataValueCollectionModifier().write(0, CollectionsKt.listOf(wrappedDataValueArray));

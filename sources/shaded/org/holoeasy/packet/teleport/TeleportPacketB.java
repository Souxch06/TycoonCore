...
implements ITeleportPacket {
    ...
    public PacketContainer teleport(int n, @NotNull Location location) {
        ...
        PacketContainer packetContainer = PacketBuilderKt.packet(packetType, (Function1<? super PacketContainer, Unit>)new Function1<PacketContainer, Unit>(n, location){
            ...
            public final void invoke(@NotNull PacketContainer packetContainer) {
                ...
                StructureModifier structureModifier2 = packetContainer.getDoubles();
                Intrinsics.checkNotNullExpressionValue(structureModifier2, "getDoubles(...)");
                StructureModifierExtKt.set(structureModifier2, 0, this.$location.getX());
                StructureModifier structureModifier3 = packetContainer.getDoubles();
                Intrinsics.checkNotNullExpressionValue(structureModifier3, "getDoubles(...)");
                StructureModifierExtKt.set(structureModifier3, 1, this.$location.getY());
                ...
                StructureModifierExtKt.set(structureModifier4, 2, this.$location.getZ());

...
extends ComparisonsKt__ComparisonsKt {
    ...
    @NotNull
    public static final <T extends Comparable<? super T>> T maxOf(@NotNull T t, T ... TArray) {
        Intrinsics.checkNotNullParameter(t, "a");
    ...
    @SinceKotlin(version="1.4")
    @NotNull
    public static final <T extends Comparable<? super T>> T minOf(@NotNull T t, T ... TArray) {
        Intrinsics.checkNotNullParameter(t, "a");
        Intrinsics.checkNotNullParameter(TArray, "other");
        T t2 = t;
        for (T t3 : TArray) {

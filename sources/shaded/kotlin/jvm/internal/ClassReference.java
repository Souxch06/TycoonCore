    ...
    public static final class Companion {
        ...
        public final String getClassSimpleName(@NotNull Class<?> clazz) {
            ...
            block9: {
                ...
                if (clazz.isArray()) {
                    ...
                    if ((clazz2.isPrimitive() ? ((string = (String)simpleNames.get(clazz2.getName())) != null ? string + "Array" : null) : (object = null)) == null) {
                        object = "Array";
                    }
                } else {
                    object = (String)simpleNames.get(clazz.getName());
                    if (object == null) {
        ...
        public final String getClassQualifiedName(@NotNull Class<?> clazz) {
            ...
            if (clazz.isAnonymousClass()) {
                ...
                String string2;
                Class<?> clazz2 = clazz.getComponentType();
                if ((clazz2.isPrimitive() ? ((string2 = (String)classFqNames.get(clazz2.getName())) != null ? string2 + "Array" : null) : (string = null)) == null) {
                    string = "kotlin.Array";
                }
            } else {
                string = (String)classFqNames.get(clazz.getName());
                if (string == null) {
        ...
        public final boolean isInstance(@Nullable Object object, @NotNull Class<?> clazz) {
            ...
            Constable constable = (Integer)map.get(clazz);
            if (constable != null) {
                Integer n = constable;
            ...
            constable = clazz.isPrimitive() ? JvmClassMappingKt.getJavaObjectType(JvmClassMappingKt.getKotlinClass(clazz)) : clazz;
            return ((Class)constable).isInstance(object);
        }

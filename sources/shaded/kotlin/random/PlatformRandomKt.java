...
public final class PlatformRandomKt {
    ...
    public static final java.util.Random asJavaRandom(@NotNull Random random) {
        ...
        Object object = random instanceof AbstractPlatformRandom ? (AbstractPlatformRandom)random : null;
    ...
    public static final Random asKotlinRandom(@NotNull java.util.Random random) {
        Intrinsics.checkNotNullParameter(random, "<this>");
        Object object = random instanceof KotlinRandom ? (KotlinRandom)random : null;

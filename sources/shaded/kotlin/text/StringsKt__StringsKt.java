...
extends StringsKt__StringsJVMKt {
    ...
    @NotNull
    public static final CharSequence trim(@NotNull CharSequence charSequence, char ... cArray) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
    ...
    @NotNull
    public static final String trim(@NotNull String string, char ... cArray) {
        Intrinsics.checkNotNullParameter(string, "<this>");
        Intrinsics.checkNotNullParameter(cArray, "chars");
    ...
    @NotNull
    public static final CharSequence trimStart(@NotNull CharSequence charSequence, char ... cArray) {
    ...
    @NotNull
    public static final String trimStart(@NotNull String string, char ... cArray) {
        CharSequence charSequence;
        block1: {
            Intrinsics.checkNotNullParameter(string, "<this>");
            Intrinsics.checkNotNullParameter(cArray, "chars");
    ...
    @NotNull
    public static final CharSequence trimEnd(@NotNull CharSequence charSequence, char ... cArray) {
        CharSequence charSequence2;
        block2: {
            Intrinsics.checkNotNullParameter(charSequence, "<this>");
            Intrinsics.checkNotNullParameter(cArray, "chars");
    ...
    @NotNull
    public static final String trimEnd(@NotNull String string, char ... cArray) {
        CharSequence charSequence;
        block2: {
            Intrinsics.checkNotNullParameter(string, "<this>");
            Intrinsics.checkNotNullParameter(cArray, "chars");
    ...
    public static final CharSequence replaceRange(@NotNull CharSequence charSequence, int n, int n2, @NotNull CharSequence charSequence2) {
        ...
        Intrinsics.checkNotNullExpressionValue(stringBuilder.append(charSequence, 0, n), "append(...)");
        stringBuilder.append(charSequence2);
        Intrinsics.checkNotNullExpressionValue(stringBuilder.append(charSequence, n2, charSequence.length()), "append(...)");
        return stringBuilder;
    }

...
extends StringsKt__StringBuilderJVMKt {
    ...
    @NotNull
    public static final StringBuilder append(@NotNull StringBuilder stringBuilder, String ... stringArray) {
        Intrinsics.checkNotNullParameter(stringBuilder, "<this>");
    ...
    @NotNull
    public static final StringBuilder append(@NotNull StringBuilder stringBuilder, Object ... objectArray) {
        Intrinsics.checkNotNullParameter(stringBuilder, "<this>");

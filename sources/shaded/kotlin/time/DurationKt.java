...
public final class DurationKt {
    ...
    public static final /* synthetic */ long getNanoseconds(int n) {
    ...
    public static final /* synthetic */ long getNanoseconds(long l) {
    ...
    public static final /* synthetic */ long getMicroseconds(int n) {
    ...
    public static final /* synthetic */ long getMicroseconds(long l) {
    ...
    public static final /* synthetic */ long getMilliseconds(int n) {
    ...
    public static final /* synthetic */ long getMilliseconds(long l) {
    ...
    public static final /* synthetic */ long getSeconds(int n) {
    ...
    public static final /* synthetic */ long getSeconds(long l) {
    ...
    public static final /* synthetic */ long getMinutes(int n) {
    ...
    public static final /* synthetic */ long getMinutes(long l) {
    ...
    public static final /* synthetic */ long getHours(int n) {
    ...
    public static final /* synthetic */ long getHours(long l) {
    ...
    public static final /* synthetic */ long getDays(int n) {
    ...
    public static final /* synthetic */ long getDays(long l) {
    ...
    private static final long parseDuration(String string, boolean bl) {
        ...
        if (string.charAt(n2) == 'P') {
            ...
            while (n2 < n) {
                ...
                Intrinsics.checkNotNullExpressionValue(string6.substring(n2, n4), "substring(...)");
                ...
                if (object2 == DurationUnit.SECONDS && n6 > 0) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(string9.substring(n3, n6), "substring(...)");
            ...
            if (StringsKt.regionMatches(string, n2, string2, 0, Math.max(n - n2, string2.length()), true)) {
                ...
                while (n2 < n) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(string14.substring(n2, n11), "substring(...)");
                    ...
                    Intrinsics.checkNotNullExpressionValue(string18, "substring(...)");
                    string13 = string18;
                    n2 += string13.length();
                    ...
                    if (n9 > 0) {
                        ...
                        Intrinsics.checkNotNullExpressionValue(string20, "substring(...)");
                        string16 = string20;
                        ...
                        Intrinsics.checkNotNullExpressionValue(string22, "substring(...)");

...
public final class ListBuilderKt {
    ...
    private static final <T> String subarrayContentToString(T[] TArray, int n, int n2, Collection<? extends T> collection) {
    ...
    public static final /* synthetic */ String access$subarrayContentToString(Object[] objectArray, int n, int n2, Collection collection) {
        return ListBuilderKt.subarrayContentToString(objectArray, n, n2, collection);
    }

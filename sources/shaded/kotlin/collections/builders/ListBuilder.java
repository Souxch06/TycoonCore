...
KMutableList {
    ...
    public <T> T[] toArray(@NotNull T[] TArray) {
        ...
        if (TArray.length < this.length) {
            ...
            Intrinsics.checkNotNullExpressionValue(TArray2, "copyOfRange(...)");
            return TArray2;
        }
    ...
    private final void ensureCapacityInternal(int n) {
        ...
        if (n > this.array.length) {
            int n2 = AbstractList.Companion.newCapacity$kotlin_stdlib(this.array.length, n);
    ...
    private final int retainOrRemoveAllInternal(int n, int n2, Collection<? extends E> collection, boolean bl) {
        ...
        int n4;
        if (this.backing != null) {
            n4 = super.retainOrRemoveAllInternal(n, n2, collection, bl);
        } else {
            int n5 = 0;
            int n6 = 0;
            while (n5 < n2) {
                if (collection.contains(this.array[n + n5]) == bl) {
                    this.array[n + n6++] = this.array[n + n5++];
                    continue;
                }
                ++n5;
            }
            ...
            int n9 = this.length;
            int n10 = n + n6;
            ArraysKt.copyInto(EArray, EArray2, n10, n8, n9);
    ...
    KMutableListIterator {
        ...
        public Itr(@NotNull ListBuilder<E> listBuilder, int n) {
            ...
            this.index = n;
            this.lastIndex = -1;
            this.expectedModCount = ((ListBuilder)listBuilder).modCount;
        }

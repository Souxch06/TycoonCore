...
const CONTRACTS = [
  ...
  },
  {
    ...
    methods: [
      ...
      { name: 'ability', returns: 'Ability', arity: 3, static: false },
    ...
    mustContain: ['class Ability', 'class KindConfig', 'fromTier', 'treasure.items',
                  'Math.max(0, this.maxTier - 1)'],
  ...
  },
  {
    ...
    methods: [
      { name: 'vein', returns: 'List', arity: 4, static: false },
      { name: 'tree', returns: 'List', arity: 3, static: false },
  ...
  },
  {
    ...
    mustContain: ['event.setCancelled(true)', 'this.handling = true', 'this.handling = false',
                  'giveOrDrop(player, world, block, drop)', 'breakWithAbilities'],
  ...
  },
  {
    ...
    mustContain: ['implements InventoryHolder', 'class Handler implements Listener', 'setCancelled(true)',
                  'runTask(plugin', 'view.track(', 'SLOT_SELL_ALL'],
